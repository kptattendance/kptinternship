...
export default function YearStatisticsView() {
  ...
  return (
    <div className=" bg-gradient-to-br from-blue-50 via-indigo-100 to-purple-200 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
        {/* Header Section */}
        <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-6 gap-4">
          <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent text-center sm:text-left">
          ...
          <div className="flex items-center justify-center sm:justify-end gap-2 sm:gap-3">
            ...
            <input
              ...
              className="border border-gray-300 rounded-lg px-2 py-1 w-24 sm:w-28 text-center focus:ring-2 focus:ring-indigo-400 focus:outline-none text-sm sm:text-base"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto rounded-lg border border-gray-200">
            <table className="min-w-[700px] sm:min-w-full text-xs sm:text-sm border-collapse w-full">

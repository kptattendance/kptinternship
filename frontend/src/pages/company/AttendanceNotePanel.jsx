        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-stone-700 mt-2 leading-relaxed">
              ...
              during each month. Do <strong>not</strong> enter the total working
              days — the college already maintains internship duration,
              weekends, and academic calendar.
            </p>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-amber-100 text-stone-700">
                      <tr>
                        ...
                        <th className="px-3 py-2 text-center">Calendar Days</th>
                        <th className="px-3 py-2 text-left">Internship Days</th>
